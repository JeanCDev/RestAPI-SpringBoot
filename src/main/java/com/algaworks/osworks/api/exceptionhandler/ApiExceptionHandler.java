...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<Object> handleNotFoundEntity(BusinessException ex, WebRequest request) {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
			...
			var problem = new Problem();
			problem.setStatus(status.value());
			problem.setMessage("Um ou mais campos estão inválidos. Preencha corretamente e tente novamnete");
			problem.setDate(OffsetDateTime.now());
